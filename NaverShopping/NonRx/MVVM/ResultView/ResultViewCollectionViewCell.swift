//
//  ResultViewCollectionViewCell.swift
//  NaverShopping
//
...
final class ResultViewCollectionViewCell: BaseCollectionViewCell {
    
    static let id = "ResultViewCollectionViewCell"
...
extension ResultViewCollectionViewCell {
